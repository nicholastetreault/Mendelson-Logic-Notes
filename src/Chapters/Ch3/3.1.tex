    ...
    \item \begin{enumerate} [label = \roman*.]
        ...
        \end{enumerate}
            ...
            \begin{enumerate} [label = \arabic*.]
                ...
                \tem Then $\proves \big(\overline{m+n}\big)' = \overline{m}+(\overline{n})'$ by (S2') and (S6').
...
c. $\proves ((\forall x)(x<y \imp \B(x)) \land (\forall x)(x \geq y \immp \C(x))) \imp (\forall x)(\B(x) \lor \C(x))$.\\
...
\begin{enumerate} [label = \roman*.]
    \item \begin{enumerate} [label = \arabic*.]
        ...
        \item \begin{tabular}{p{8cm} r}
            ...
            \end{tabular}
        \item \begin{tabular}{p{8cm} r}
            $0 = y \cdot 0 + 0 \lnd 0 < y$ & 2, 3, conjunction rule
            \end{tabular}
        \item \begin{tabular}{p{8cm} r}
    ...
    \item \begin{enumerate} [label = \arabic*.]
        ...
        \item \begin{tabular}{p{8cm} r}
            ...
            \end{tabular}
        \item \begin{tabular}{p{8cm} r}
            $b' < y \imp (\exists u)(\exists v)(x' = y \codt u + v \land v < y)$ & 8, rule E4, ded. them.
            \end{tabular}
        \item \begin{tabular}{p{8cm} r}
